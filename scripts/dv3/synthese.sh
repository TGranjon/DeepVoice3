...
#python synthesis_cop.py /lium/raid01_b/tgranjon/dv3/checkpoints/average.pth tests/test_fr/learn.txt /lium/raid01_b/tgranjon/dv3/synthesis --preset=presets/deepvoice3_synpaflex.json
